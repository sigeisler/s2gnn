...
from torch_geometric.graphgym.config import (assert_cfg, cfg, dump_cfg,
                                             set_cfg, load_cfg,
                                             makedirs_rm_exist)
...
def custom_set_out_dir(cfg, cfg_fname, name_tag):
    ...
    run_name = f"{now}-" + run_name
    run_name += f"-{name_tag}" if name_tag else ""
    cfg.out_dir = os.path.join(cfg.out_dir, date, run_name)
...
if __name__ == '__main__':
    ...
    # Allow post mp layers to be zero
