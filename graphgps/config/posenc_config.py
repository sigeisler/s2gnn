...
def set_cfg_posenc(cfg):
    ...
    for name in ['posenc_LapPE', 'posenc_SignNet', 'posenc_MagLapPE',
    ...
    # Config for MagLap
    cfg.posenc_MagLapPE.q = 0.000005
    cfg.posenc_MagLapPE.max_freqs = 10
    # The normalization scheme for the graph Laplacian: 'none', 'sym', or 'rw'
    cfg.posenc_MagLapPE.laplacian_norm = 'sym'
    cfg.posenc_MagLapPE.which = 'SA'
    cfg.posenc_MagLapPE.drop_trailing_repeated = False
    cfg.posenc_MagLapPE.largest_connected_component = True
    cfg.posenc_MagLapPE.positional_encoding = False
    # We directly add the positional encodings to the embedded node features
    cfg.posenc_MagLapPE.dim_pe = 0
    cfg.posenc_MagLapPE.sparse = True
    cfg.posenc_MagLapPE.kwargs = CN()
    cfg.posenc_MagLapPE.precompute = False
